...
public final class ButterKnife {
    ...
    public interface Injector<T> {
        ...
        void setContentView(Object source);
    }
    ...
    static final Injector<Object> NOP_INJECTOR = new Injector<Object>() {
        ...
        @Override
        public void setContentView(Object source) {
...
//            if (contentView != null) {
//                ((Activity) target).setContentView(contentView.value());
//            }
//        }
        try {
            if (debug) Log.d(TAG, "Looking up view injector for " + targetClass.getName());
            Injector<Object> injector = findInjectorForClass(targetClass);
            if (injector != null) {
                injector.setContentView(source);
